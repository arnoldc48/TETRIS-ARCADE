...
// Melodía de la canción de Tetris con notas extendidas
int musica[] = {
...
int musica_tempo[] = {
    12, 12, 12, 12,
    12, 12, 6, 6,  // Extensión de duración de las notas
    12, 12, 12, 12,
    12, 12, 12, 6,  // Extensión para dar más tiempo a la nota final de la frase
    12, 6, 6, 6,    // Extensión en las notas repetidas

    12, 12, 12, 12,
    12, 12, 12, 12,
    12, 12, 6, 6,   // Extensión en las notas finales de las frases
    12, 12, 12, 6,
    12, 6, 6
};
